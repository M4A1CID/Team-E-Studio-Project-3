...
public:
	...
	void Init(const int theScreen_Height, const int theScreen_Width, 
			  ...
			  const int theTileSize, const char m_Level_Num);
	...
	int GetScreenHeight(void);			// Get the number of pixels for height
	int GetScreenWidth(void);			// Get the number of pixels for width
