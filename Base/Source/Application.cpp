...
bool Application::GetKeyboardUpdate()
{
	...
	{
		scene->UpdateCameraStatus(VK_CONTROL);
	}
...
void Application::Init()
{
	...
	m_window = glfwCreateWindow(m_ksiWindow_width, m_ksiWindow_height, "DM2231_Framework",/* glfwGetPrimaryMonitor() */NULL, NULL);
...
void Application::Run()
{
	...
	while (!glfwWindowShouldClose(m_window) && !scene->m_cStates->GetQuitState() /*&& !IsKeyPressed(VK_ESCAPE)*/)
	{
