...
public:
	...
	void UpdateArrowDrawBack(double dt);
	void UpdateReloading(double dt);
...
private:
	...
	float m_LastFiredBullet;
	float m_CurrentArrowPullBack;
	int m_CurrentGunHeld;
	bool m_ArrowReadyToFire;
	bool m_ArrowWhileMouseDown;

	float m_Ammo_Total_12_7;
	float m_Ammo_Total_Reppu;
	float m_Ammo_Total_46;

	float m_Ammo_Current_12_7;
	float m_Ammo_Current_Reppu;
	float m_Ammo_Current_46;
	float m_Reload_Timer;
	bool m_Is_Reloading;
	bool m_Sound_Reloading;
	
	float m_fFps;
	float m_Weapon_Recoil;
	float m_accuracy;
	float m_Bullets_Fired;
	float m_Bullets_Hit;
